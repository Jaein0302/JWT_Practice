...
public class JwtAuthoriaztionFilter extends BasicAuthenticationFilter {
    ...
    public JwtAuthoriaztionFilter(AuthenticationManager authenticationManager, UserRepository userRepository) {
        super(authenticationManager);
        this.userRepository = userRepository;
    }

    //인증이나 권한이 필요한 주소 요청이 있을떄 해당 필터를 타게 됨
    @Override
...
//      super.doFilterInternal(request, response, chain);
        ...
        //username이 저장되었다는 것은 서명이 정상적으로 되었다는 것
